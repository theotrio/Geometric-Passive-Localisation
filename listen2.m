...
%If the sensor is closer than some tolerance distance tol then the sensor
%is aware of its location and it creates a polygon with radius tol

function [A1,B1,A2,B2,measurements,stumble_upon] = listen2(ps1,ps2,phi,mnoise,tol)
